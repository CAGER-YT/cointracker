...
//     useEffect(() => {
//       if (open) {
//         fetchLastTotalCoins(); // Fetch when form opens
//       }
//     }, [open]);

//     // Fetch last total coins from API
//     const fetchLastTotalCoins = () => {
//       api
//         .get("/api/coins/last") // Make sure this API returns the latest total coins value
//         .then((response) => {
//           setLastTotalCoins(response.data.totalCoins || 0);
//         })
//         .catch((error) => console.error("Error fetching last total coins:", error));
//     };

//     // Calculate the difference when user enters a new value
//     const handleCoinInputChange = (e) => {
//       const newCoins = Number(e.target.value);
//       setCoins(newCoins);
//       setDifference(newCoins - lastTotalCoins); // Difference calculation
//     };
